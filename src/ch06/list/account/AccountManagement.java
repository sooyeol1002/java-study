...
//        Account add = new Account(accountNumber, balance);
        accountList.add(new Account(accountNumber,balance)); // 뒤에 값 추가
//        accountList.set(numAccounts, add); // 사용의미가 없음
    ...
    public void showAccountList() {
        ...
        for (int i = 0; i < numAccounts; i++) {
            ...
            System.out.println(accountList.get(i).getAccountNumber() + " : [계좌번호" + (i + 1) + "], " + accountList.get(i).getBalance() + " : [잔액 " + (i + 1) + "]");
        }
